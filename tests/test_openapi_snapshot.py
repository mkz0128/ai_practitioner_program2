...
EXPECTED_PATHS = {
    ...
    "/api/v1/dispatch-rules/confirm",
    "/api/v1/dispatch-rules/{rule_id}/deactivate",
    "/api/v1/dispatch-parameters",
    "/api/v1/runtime/reset",
    "/api/v1/dispatch-parameters/confirm",
    "/api/v1/plans",
    "/api/v1/plans/compare",
    "/api/v1/plans/{plan_id}",
    "/api/v1/plans/{plan_id}/versions",
    "/api/v1/plans/{plan_id}/restore",
    "/api/v1/plans/{plan_id}/delay-preview",
